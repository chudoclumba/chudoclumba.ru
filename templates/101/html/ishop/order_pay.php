...
Сумма платежа:&nbsp;<input type="text" class="fbinp" name="summa" id="summa" value="<?=number_format($summacn,2,'.','')?>" style="width: 80px"/>
...
<br><br><button class="albutton alorange" name="send" type="submit" value="Оплатить"><span><span><span class="ok">Оплатить</span></span></span></button></form>	
