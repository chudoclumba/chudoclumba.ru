...
width:\'90%\',height:\'90%\',autoSize:false,closeClick:false,openEffect	: \'none\',	closeEffect	: \'none\'});});</script>';
			...
			case 'show_prd_vs' :
			{
				...
				$content = array (
					'html' => $prd_list,
					'meta_title' => 'Добавлено к стравнению',
					'meta_keys' =>  'Добавлено к стравнению',
					'meta_desc' => 'Добавлено к стравнению',
					'path' => 'Добавлено к стравнению'
				);
				break;
			}
