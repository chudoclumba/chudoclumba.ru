<?php
	...
	// Preview options
	$mcImageManagerConfig['preview.wwwroot'] = $_SERVER['DOCUMENT_ROOT']; // absolute or relative from this script path, try to leave blank system figures it out. 
	...
	$mcImageManagerConfig['createdir.exclude_directory_pattern'] = '/[^a-zA-Z0-9_\-\.]/';
	...
	$mcImageManagerConfig['filesystem.rootpath'] = $basepath.'../../../../../'.'data'; // absolute or relative from this script path, required.
	...
	$mcImageManagerConfig['filesystem.extensions'] = "gif,jpg,jpeg,png,bmp,swf,mov,avi,mpg,mpeg,flv,csv,xls,xlsx,rar,zip,doc,docx,txt,pdf,xml,css,html,wmv,wma,mp3,ogg,wav";
	...
	$mcImageManagerConfig['upload.extensions'] = "gif,jpg,jpeg,png,bmp,swf,mov,avi,mpg,mpeg,flv,csv,xls,xlsx,rar,zip,doc,docx,txt,pdf,xml,css,html,wmv,wma,mp3,ogg,wav";
