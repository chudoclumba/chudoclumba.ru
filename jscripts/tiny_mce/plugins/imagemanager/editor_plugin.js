...
(function() {
	window.mcImageManager = {
		...
		browse : function(s) {
			...
			lft=parseInt(screen.width) - 950-150;
			this.openWin({page : 'index.html',left:lft,  width : 950, height : 800,scrollbars : 'yes'}, s);
		},

		edit : function(s) {
			this.openWin({page : 'edit.html', width : 950, height : 800}, s);
		},
		...
		view : function(s) {
			this.openWin({page : 'view.html', width : 950, height : 800}, s);
		},
		...
		filebrowserCallBack : function(fn, u, ty, w, ask) {
			...
			turl='';
			if (w.document.forms[0][fn].value>'') {
				turl='/'+w.document.forms[0][fn].value;
			}
			t.browse(t.extend(s, {
				url :turl,
				relative_urls : 0,
