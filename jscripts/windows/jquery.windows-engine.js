...
$.fn.newWindow = function(options){
    ...
    $windowTitleBar = $('<div class="window_title"></div>');        
    $windowTitleBarL = $('<div class="w_left"></div>');        
    $windowTitleBarR = $('<div class="w_right"></div>');        
    $windowTitleBarC = $('<div class="w_center"></div>');        
	...
	$windowContentL = $('<div class="w_center_l"></div>');
	$windowContentR = $('<div class="w_center_r"></div>');
	$windowContentC = $('<div class="w_center_c"></div>');
	...
	$windowTitleBarC.bind('mousedown', function(e){
	...
	$windowMaximizeButton.bind('click', function(e){
	  ...
	  if($obj.attr("state") == "normal"){
		  if(options.windowType=="standard"){
			...
			move($obj, 5, 5);
		    resize($obj,$(window).width()-15,$(window).height()-55);
			$obj.attr("lastX",tmpx);
		    $obj.attr("lastY",tmpy);
	...
	$windowTitleBarC.append(options.windowTitle);
	...
	$windowTitleBar.append($windowTitleBarL)
	$windowTitleBarL.append($windowTitleBarR)
	$windowTitleBarR.append($windowTitleBarC)
	$windowContainer.append($windowContentL)
	$windowContentL.append($windowContentR)
	$windowContentR.append($windowContentC)
	$windowContentC.append($windowContent)
			...
			if(options.ajaxURL != ""){ 
				 ...
				 $.ajax({
				   ...
				   success: function(data){
					 $window.children('div').children('div').children('div').children(".window-content").html(data);
