...
jQuery(document).ready(function($) {
  $('<div></div>').html(IE6UPDATE_OPTIONS.message || 'Internet Explorer может некорректно отображать содержимое данного сайта. Нажмите для обновления...')
