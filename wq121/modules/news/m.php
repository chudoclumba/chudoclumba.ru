...
$btns = array(
	'Список новостей'=>array('id'=>1,'href'=>''),
	'Подписчики'=>array('id'=>2,'href'=>'javascript:location.href=\'include.php?place=news&action=users\'')
...
<div class="news_pan">
 ...
 <div class="adv_news_pan">
  <?php echo button1('Создать новость', "javascript: location.href = '".$prelink.'&action=sub&eID=-1'."'",'','add')?>
 </div>
 <div class="clear"></div>
...
<p>По кнопке Тестовая рассылка выбранная новость будет отправлена на chudoclumba@yandex.ru</p>
<?
