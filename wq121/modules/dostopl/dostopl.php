<?php
$module['scripts'] = '<script type="text/javascript" src="'.(MODULES_PATH.$global_place).'/dostopl.js"></script>';
...
*/
$btns = array(
	'Доставка и оплата'=>array('id'=>1,'href'=>'')
);

$module['html'] .= get_main_page(0, '');;